...
RUBRIC_SECTIONS = {
    ...
    "S2": {"name": "Overview & Goals", "max_points": 14, "criticality": "CRITICAL", "consequence": "Score <7/14 caps max grade at C"},
    "S3": {"name": "User Roles & Permissions", "max_points": 18, "criticality": "CRITICAL", "consequence": "Score <9/18 caps max grade at C"},
    "S4": {"name": "Core Features & User Flows", "max_points": 14, "criticality": "CRITICAL", "consequence": "Score <7/14 caps max grade at C"},
    "S5": {"name": "Authentication & Onboarding", "max_points": 9, "criticality": "IMPORTANT", "consequence": "Score <4.5/9 caps max grade at B"},
    "S6": {"name": "Error Handling & Edge Cases", "max_points": 5, "criticality": "REQUIRED", "consequence": "Score of 0 = notable gap"},
    "S7": {"name": "Data Model", "max_points": 9, "criticality": "IMPORTANT", "consequence": "Score <4.5/9 caps max grade at B"},
    "S8": {"name": "API Design & UI/UX", "max_points": 9, "criticality": "IMPORTANT", "consequence": "Score <4.5/9 caps max grade at B"},
    "S9": {"name": "Non-Functional Requirements", "max_points": 5, "criticality": "REQUIRED", "consequence": "Score of 0 = notable gap"},
    "S10": {"name": "Category-Specific Guidelines", "max_points": 7, "criticality": "CATEGORY-SPECIFIC", "consequence": "Category mechanic must drive S3/S5/S6/S7/S11"},
...
PRD_SECTIONS = [
    "Overview", "Goals & Non-Goals", "User Roles & Permissions",
    "Authentication & Onboarding", "Core Features & User Flows",
    "Data Model", "API Design", "UI/UX Requirements",
    "Error Handling & Edge Cases", "Non-Functional Requirements",
...
def score_prd(prd_text: str, category: str = "Knowledge") -> dict:
    """
