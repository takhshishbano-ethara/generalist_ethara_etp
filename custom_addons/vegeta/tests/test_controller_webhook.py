...
from ..controllers.main import VegetaController
...
@tagged("post_install", "-at_install", "vegeta")
class TestWebhookPayloadValidation(VegetaTestCase):
...
@tagged("post_install", "-at_install", "vegeta")
class TestWebhookIdempotency(VegetaTestCase):
...
@tagged("post_install", "-at_install", "vegeta")
class TestWebhookSuccessPath(VegetaTestCase):
...
@tagged("post_install", "-at_install", "vegeta")
class TestGetJobStatus(VegetaTestCase):
