...
const vegetaBusService = {
    ...
    start(env, { bus_service, action }) {
        ...
        function reloadCurrentForm(payload) {
            ...
            if (controller.props.resModel !== "vegeta.job") {
                return;
            }
        ...
        bus_service.subscribe("vegeta/job_state", reloadCurrentForm);
        bus_service.subscribe("vegeta/job_done", reloadCurrentForm);
        bus_service.addChannel("vegeta_job_updates");
    },
};

registry.category("services").add("vegeta_bus", vegetaBusService);
