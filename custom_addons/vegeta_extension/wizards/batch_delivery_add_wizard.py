...
class VegetaBatchDeliveryAddWizard(models.TransientModel):
    _name = "vegeta.batch.delivery.add.wizard"
    _description = "Add Vegeta Jobs to Batch Delivery"
    ...
    def default_get(self, fields_list):
        ...
        if active_model == "vegeta.job" and active_ids:
    ...
    def action_confirm(self):
        ...
        if self.mode == "existing":
            ...
            batch = self.env["vegeta.batch.delivery"].create({
        ...
        return {
            ...
            "res_model": "vegeta.batch.delivery",
            "res_id": batch.id,
            "view_mode": "form",
            "target": "current",
        }
