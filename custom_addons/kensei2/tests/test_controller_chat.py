...
from ..controllers.chat import Kensei2ChatController


# ═══════════════════════════════════════════════════════════════════════
#  /kensei2/chat/create_turn
# ═══════════════════════════════════════════════════════════════════════

@tagged("post_install", "-at_install")
class TestChatCreateTurn(Kensei2TestCase):
...
# ═══════════════════════════════════════════════════════════════════════
#  /kensei2/chat/save_response
# ═══════════════════════════════════════════════════════════════════════

@tagged("post_install", "-at_install")
class TestChatSaveResponse(Kensei2TestCase):
...
# ═══════════════════════════════════════════════════════════════════════
#  /kensei2/chat/save_qc
# ═══════════════════════════════════════════════════════════════════════

@tagged("post_install", "-at_install")
class TestChatSaveQC(Kensei2TestCase):
...
# ═══════════════════════════════════════════════════════════════════════
#  /kensei2/chat/save_feedback
# ═══════════════════════════════════════════════════════════════════════

@tagged("post_install", "-at_install")
class TestChatSaveFeedback(Kensei2TestCase):
...
# ═══════════════════════════════════════════════════════════════════════
#  /kensei2/chat/save_trajectory
# ═══════════════════════════════════════════════════════════════════════

@tagged("post_install", "-at_install")
class TestChatSaveTrajectory(Kensei2TestCase):
    ...
    def test_save_trajectory_extracts_tool_calls(self):
        ...
        extracted = Kensei2ChatController._extract_tool_calls_from_trajectory(traj_json)
    ...
    def test_save_trajectory_extracts_tokens(self):
        ...
        token_usage = Kensei2ChatController._extract_token_usage_from_trajectory(traj_json)
    ...
    def test_save_trajectory_keeps_better_calls(self):
        ...
        extracted_fewer = Kensei2ChatController._extract_tool_calls_from_trajectory(traj_fewer)
        ...
        extracted_more = Kensei2ChatController._extract_tool_calls_from_trajectory(traj_more)
        existing_list = json.loads(turn.tool_calls)
    ...
    def test_save_trajectory_empty(self):
        ...
        result = Kensei2ChatController._extract_tool_calls_from_trajectory("")
        self.assertEqual(result, [])

        result2 = Kensei2ChatController._extract_tool_calls_from_trajectory("[]")
        self.assertEqual(result2, [])

        result3 = Kensei2ChatController._extract_tool_calls_from_trajectory(None)
        self.assertEqual(result3, [])

        token_result = Kensei2ChatController._extract_token_usage_from_trajectory("")
        self.assertEqual(token_result, {"input_tokens": 0, "output_tokens": 0})

        token_result2 = Kensei2ChatController._extract_token_usage_from_trajectory(None)
        self.assertEqual(token_result2, {"input_tokens": 0, "output_tokens": 0})


# ═══════════════════════════════════════════════════════════════════════
#  /kensei2/chat/history
# ═══════════════════════════════════════════════════════════════════════

@tagged("post_install", "-at_install")
class TestChatHistory(Kensei2TestCase):
    ...
    def test_history_backfills_tool_calls(self):
        ...
        if not tool_calls_str and turn.trajectory_messages:
            extracted = Kensei2ChatController._extract_tool_calls_from_trajectory(
...
# ═══════════════════════════════════════════════════════════════════════
#  /kensei2/chat/export_session
# ═══════════════════════════════════════════════════════════════════════

@tagged("post_install", "-at_install")
class TestExportSession(Kensei2TestCase):
...
# ═══════════════════════════════════════════════════════════════════════
#  /kensei2/chat/sandbox_state
# ═══════════════════════════════════════════════════════════════════════

@tagged("post_install", "-at_install")
class TestSandboxState(Kensei2TestCase):
...
@tagged("post_install", "-at_install")
class TestChatControllerErrorPaths(Kensei2TestCase):
    """Error-path tests that exercise the controller methods directly."""

    def _ctrl(self):
        return Kensei2ChatController()
