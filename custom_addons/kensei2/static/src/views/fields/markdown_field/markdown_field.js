...
export class Kensei2MarkdownField extends Component {
    static template = "kensei2.MarkdownField";
    static props = {
        ...standardFieldProps,
...
export const kensei2MarkdownField = {
    component: Kensei2MarkdownField,
...
registry.category("fields").add("kensei2_markdown", kensei2MarkdownField);
