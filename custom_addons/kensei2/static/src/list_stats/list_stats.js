...
export class Kensei2ListStats extends Component {
    static template = "kensei2.ListStats";
    static props = {
        cards: { type: Array },
...
export class Kensei2StatsListController extends ListController {
    static template = "kensei2.StatsListView";
    ...
    async _loadStats() {
        ...
        try {
            const res = await rpc("/kensei2/tracker/list_stats", {
...
registry.category("views").add("kensei2_stats_list", {
    ...listView,
