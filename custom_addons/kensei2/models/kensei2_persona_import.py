...
class Kensei2PersonaImport(models.TransientModel):
    ...
    reused verbatim from kensei2.tracker.bulk.allocation._persona_entries(), so the
    ...
    def action_import(self):
        ...
        helper = self.env['kensei2.tracker.bulk.allocation'].create({
            'source_mode': 'file',
    ...
    def action_open_bulk_allocation(self):
        ...
        return {
            ...
            'res_model': 'kensei2.tracker.bulk.allocation',
            'view_mode': 'form',
            'target': 'new',
