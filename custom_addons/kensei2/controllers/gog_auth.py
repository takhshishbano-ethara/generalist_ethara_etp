...
def _gog_config_dir(task_id):
    ...
    base = os.path.join(tempfile.gettempdir(), ".kensei2-gog-config")
...
class Kensei2GogAuthController(http.Controller):
    ...
    @http.route("/kensei2/gog/start_auth", type="json", auth="user")
    ...
    @http.route("/kensei2/gog/exchange_token", type="json", auth="user")
    ...
    @http.route("/kensei2/gog/status", type="json", auth="user")
