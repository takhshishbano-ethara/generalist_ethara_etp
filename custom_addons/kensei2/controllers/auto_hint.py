...
from ..models.kensei2 import _load_dotenv, _is_degenerate_output
from .llm_assisst_qc import _call_bedrock_converse, _parse_json_response

_logger = logging.getLogger(__name__)

_AUTO_HINT_POOL = ThreadPoolExecutor(
    max_workers=3, thread_name_prefix="kensei2-auto-hint"
)
...
def _push_bus(env, sandbox, notify_partner_id, payload):
    ...
    for partner in partners:
        env["bus.bus"]._sendone(partner, "kensei2/auto_hint_result", payload)
...
class AutoHintController(http.Controller):
    ...
    @http.route("/kensei2/auto_hint_eval", type="json", auth="user")
