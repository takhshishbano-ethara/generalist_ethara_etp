...
_HINT_MOD = "odoo.addons.kensei.controllers.auto_hint"


@tagged("post_install", "-at_install")
class TestAutoHintEval(KenseiTestCase):
    ...
    def test_auto_hint_submits_background(self):
        from odoo.addons.kensei.controllers.auto_hint import AutoHintController
...
@tagged("post_install", "-at_install")
class TestAutoHintHelpers(KenseiTestCase):

    def test_format_conversation_user_messages(self):
        from odoo.addons.kensei.controllers.auto_hint import _format_conversation
...
@tagged("post_install", "-at_install")
class TestAutoHintAccumulateTokens(KenseiTestCase):

    def test_accumulate_qwen_tokens(self):
        from odoo.addons.kensei.controllers.auto_hint import _accumulate_qwen_tokens
