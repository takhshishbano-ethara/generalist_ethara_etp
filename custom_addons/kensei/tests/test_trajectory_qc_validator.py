...
class TestValidateTrajectory(KenseiTestCase):
...
@tagged("post_install", "-at_install")
class TestBuildReport(KenseiTestCase):
...
@tagged("post_install", "-at_install")
class TestHelperFunctions(KenseiTestCase):
...
@tagged("post_install", "-at_install")
class TestHintsMode(KenseiTestCase):
...
@tagged("post_install", "-at_install")
class TestEnvelopeEdgeCases(KenseiTestCase):
...
@tagged("post_install", "-at_install")
class TestToolCallEdgeCases(KenseiTestCase):
...
@tagged("post_install", "-at_install")
class TestMetaInfoEdgeCases(KenseiTestCase):
