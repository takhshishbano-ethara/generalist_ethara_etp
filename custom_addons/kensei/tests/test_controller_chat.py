...
from ..controllers.chat import KenseiChatController


# ═══════════════════════════════════════════════════════════════════════
#  /kensei/chat/create_turn
# ═══════════════════════════════════════════════════════════════════════

@tagged("post_install", "-at_install")
class TestChatCreateTurn(KenseiTestCase):
...
# ═══════════════════════════════════════════════════════════════════════
#  /kensei/chat/save_response
# ═══════════════════════════════════════════════════════════════════════

@tagged("post_install", "-at_install")
class TestChatSaveResponse(KenseiTestCase):
...
@tagged("post_install", "-at_install")
class TestChatSaveQC(KenseiTestCase):
...
# ═══════════════════════════════════════════════════════════════════════
#  /kensei/chat/save_feedback
# ═══════════════════════════════════════════════════════════════════════

@tagged("post_install", "-at_install")
class TestChatSaveFeedback(KenseiTestCase):
...
# ═══════════════════════════════════════════════════════════════════════
#  /kensei/chat/save_trajectory
# ═══════════════════════════════════════════════════════════════════════

@tagged("post_install", "-at_install")
class TestChatSaveTrajectory(KenseiTestCase):
    ...
    def test_save_trajectory_extracts_tool_calls(self):
        ...
        extracted = KenseiChatController._extract_tool_calls_from_trajectory(traj_json)
    ...
    def test_save_trajectory_extracts_tokens(self):
        ...
        token_usage = KenseiChatController._extract_token_usage_from_trajectory(traj_json)
    ...
    def test_save_trajectory_keeps_better_calls(self):
        ...
        extracted_fewer = KenseiChatController._extract_tool_calls_from_trajectory(traj_fewer)
        ...
        extracted_more = KenseiChatController._extract_tool_calls_from_trajectory(traj_more)
        existing_list = json.loads(turn.tool_calls)
    ...
    def test_save_trajectory_empty(self):
        ...
        result = KenseiChatController._extract_tool_calls_from_trajectory("")
        self.assertEqual(result, [])

        result2 = KenseiChatController._extract_tool_calls_from_trajectory("[]")
        self.assertEqual(result2, [])

        result3 = KenseiChatController._extract_tool_calls_from_trajectory(None)
        self.assertEqual(result3, [])

        token_result = KenseiChatController._extract_token_usage_from_trajectory("")
        self.assertEqual(token_result, {"input_tokens": 0, "output_tokens": 0})

        token_result2 = KenseiChatController._extract_token_usage_from_trajectory(None)
...
@tagged("post_install", "-at_install")
class TestChatHistory(KenseiTestCase):
    ...
    def test_history_backfills_tool_calls(self):
        ...
        if not tool_calls_str and turn.trajectory_messages:
            extracted = KenseiChatController._extract_tool_calls_from_trajectory(
...
# ═══════════════════════════════════════════════════════════════════════
#  /kensei/chat/export_session
# ═══════════════════════════════════════════════════════════════════════

@tagged("post_install", "-at_install")
class TestExportSession(KenseiTestCase):
...
# ═══════════════════════════════════════════════════════════════════════
#  /kensei/chat/sandbox_state
# ═══════════════════════════════════════════════════════════════════════

@tagged("post_install", "-at_install")
class TestSandboxState(KenseiTestCase):
...
@tagged("post_install", "-at_install")
class TestChatControllerErrorPaths(KenseiTestCase):
    """Error-path tests that exercise the controller methods directly."""

    def _ctrl(self):
        return KenseiChatController()
