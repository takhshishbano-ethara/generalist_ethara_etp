...
export class KenseiMarkdownField extends Component {
    static template = "kensei.MarkdownField";
    static props = {
        ...standardFieldProps,
...
export const kenseiMarkdownField = {
    component: KenseiMarkdownField,
...
registry.category("fields").add("kensei_markdown", kenseiMarkdownField);
