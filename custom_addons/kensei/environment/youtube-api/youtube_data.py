    ...
    for r in rows:
        out.append({
            ...
            "snippet": {
                ...
                "thumbnails": {
                    "default": {"url": r["thumbnailUrl"].replace("maxresdefault", "default"), "width": 120, "height": 90},
                    "medium": {"url": r["thumbnailUrl"].replace("maxresdefault", "mqdefault"), "width": 320, "height": 180},
                    "high": {"url": r["thumbnailUrl"].replace("maxresdefault", "hqdefault"), "width": 480, "height": 360},
                    "maxres": {"url": r["thumbnailUrl"], "width": 1280, "height": 720},
                },
                ...
                "defaultLanguage": r["defaultLanguage"] if r["defaultLanguage"] else None,
                "defaultAudioLanguage": r["defaultAudioLanguage"] if r["defaultAudioLanguage"] else None,
            },
            "contentDetails": {
                "duration": r["duration"],
            ...
            "status": {
                ...
                "publishAt": r["publishAt"] if r["publishAt"] else None,
                "license": "youtube",
                "embeddable": r["embeddable"].lower() == "true",
