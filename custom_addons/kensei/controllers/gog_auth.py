...
def _gog_config_dir(task_id):
    ...
    base = os.path.join(tempfile.gettempdir(), ".kensei-gog-config")
...
class KenseiGogAuthController(http.Controller):
    ...
    @http.route("/kensei/gog/start_auth", type="json", auth="user")
    ...
    @http.route("/kensei/gog/exchange_token", type="json", auth="user")
    ...
    @http.route("/kensei/gog/status", type="json", auth="user")
