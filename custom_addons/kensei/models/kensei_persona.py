...
class KenseiPersona(models.Model):
    ...
    # ------------------------------------------------------------------ #
    #  Kensei Tracker — allocation status
    # ------------------------------------------------------------------ #
    # NB: `task_ids` above points at kensei.kensei (a different model). These are
    ...
    allocation_ids = fields.One2many(
        "kensei.tracker.allocation", "persona_id", string="Task Allocations")
    ...
    current_allocation_id = fields.Many2one(
        "kensei.tracker.allocation", string="Current Allocation",
