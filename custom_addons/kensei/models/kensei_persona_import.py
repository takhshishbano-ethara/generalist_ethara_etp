...
class KenseiPersonaImport(models.TransientModel):
    ...
    def action_import(self):
        ...
        helper = self.env['kensei.tracker.bulk.allocation'].create({
            'source_mode': 'file',
    ...
    def action_open_bulk_allocation(self):
        ...
        return {
            ...
            'res_model': 'kensei.tracker.bulk.allocation',
            'view_mode': 'form',
            'target': 'new',
