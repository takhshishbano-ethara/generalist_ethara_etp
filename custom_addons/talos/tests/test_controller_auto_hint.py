...
_HINT_MOD = "odoo.addons.talos.controllers.auto_hint"


@tagged("post_install", "-at_install")
class TestAutoHintEval(TalosTestCase):
    ...
    def test_auto_hint_submits_background(self):
        from odoo.addons.talos.controllers.auto_hint import AutoHintController
...
@tagged("post_install", "-at_install")
class TestAutoHintHelpers(TalosTestCase):

    def test_format_conversation_user_messages(self):
        from odoo.addons.talos.controllers.auto_hint import _format_conversation
