...
from ..controllers.talos_controller import Talos as TalosController
...
class TestJSONLImport(TalosTestCase):
    ...
    def _call_controller(self, jsonl_lines, url="https://example.com/data.jsonl"):
        ...
        with patch("odoo.http.request") as mock_req, \
             patch("odoo.addons.talos.controllers.talos_controller.requests.get", return_value=mock_resp) as mock_get:
