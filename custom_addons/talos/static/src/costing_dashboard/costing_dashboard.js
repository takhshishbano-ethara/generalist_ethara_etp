...
export class CostingDashboard extends Component {
    static template = "talos.CostingDashboard";
    ...
    async _loadData() {
        ...
        try {
            const res = await rpc("/talos/costing/data", { period: this.state.period });
...
registry.category("actions").add("talos_costing_dashboard", CostingDashboard);
