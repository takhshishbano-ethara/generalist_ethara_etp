...
- The prompt doesn't relate to any HEART domain (completely off-topic for the Talos project) → **FAIL**
...
Good Talos prompts should lead to multi-turn conversations. The initial prompt should leave room for natural follow-ups.
