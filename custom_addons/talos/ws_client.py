"""
Asyncio-based WebSocket client for OpenClaw gateways in Talos sandbox containers.
...
logger = logging.getLogger("talos.ws_client")
...
class OpenClawClient:
    ...
    def _next_id(self):
        self._msg_counter += 1
        ts = int(time.time())
        return f"talos-{self._msg_counter}-{ts:x}"
