...
class Era4ImageDefault(Image):
    ...
    def dependency(self) -> Image:
        return Era4ImageBase(self.pr, self._config)
...
@Instance.register("MariaDB", "server_4449_to_3853")
class Server4449To3853(Instance):
    ...
    def dependency(self) -> Optional[Image]:
        return Era4ImageDefault(self.pr, self._config)
