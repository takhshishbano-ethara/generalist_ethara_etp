...
class ImageBase(Image):
    ...
    No CMake/Meson — Makefile-only build."""
...
make
make install || true
make tests || g++ -std=c++11 -O3 tests/main.cpp -Isrc -o testsBin -lpthread -luWS -lssl -lcrypto -lz -luv
...
@Instance.register("uNetworking", "uWebSockets_749_to_679")
class UWebSockets749To679(Instance):
