"""fluxcd/flux2 config for PRs 2144-2945 (Go 1.17 era, Debian Bullseye)."""
...
class Flux2ImageBaseGo117(Image):
...
class Flux2ImageDefaultGo117(Image):
    def __init__(self, pr: PullRequest, config: Config):
        self._pr = pr
        self._config = config
    ...
    def dependency(self) -> Union[str, Image]:
        return Flux2ImageBaseGo117(self.pr, self.config)
...
""".format(repo=self.pr.repo),
    ...
    def dockerfile(self) -> str:
        ...
        if isinstance(image, str):
            raise ValueError("Flux2ImageDefaultGo117 dependency must be an Image")
...
@Instance.register("fluxcd", "flux2_2945_to_2144")
class FLUX2_2945_TO_2144(Instance):
    ...
    def dependency(self) -> Image:
        return Flux2ImageDefaultGo117(self.pr, self._config)
