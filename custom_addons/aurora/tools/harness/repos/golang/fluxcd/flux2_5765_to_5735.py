"""fluxcd/flux2 config for PRs 5735-5765 (Go 1.26 era, Debian Bookworm)."""
...
class Flux2ImageBaseGo126(Image):
...
class Flux2ImageDefaultGo126(Image):
    def __init__(self, pr: PullRequest, config: Config):
        self._pr = pr
        self._config = config
    ...
    def dependency(self) -> Union[str, Image]:
        return Flux2ImageBaseGo126(self.pr, self.config)
...
""".format(repo=self.pr.repo),
    ...
    def dockerfile(self) -> str:
        ...
        if isinstance(image, str):
            raise ValueError("Flux2ImageDefaultGo126 dependency must be an Image")
...
@Instance.register("fluxcd", "flux2_5765_to_5735")
class FLUX2_5765_TO_5735(Instance):
    ...
    def dependency(self) -> Image:
        return Flux2ImageDefaultGo126(self.pr, self._config)
