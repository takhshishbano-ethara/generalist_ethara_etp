"""fluxcd/flux2 config for PRs 3048-3653 (Go 1.18 era, Debian Bullseye)."""
...
class Flux2ImageBaseGo118(Image):
...
class Flux2ImageDefaultGo118(Image):
    def __init__(self, pr: PullRequest, config: Config):
        self._pr = pr
        self._config = config
    ...
    def dependency(self) -> Union[str, Image]:
        return Flux2ImageBaseGo118(self.pr, self.config)
...
""".format(repo=self.pr.repo),
    ...
    def dockerfile(self) -> str:
        ...
        if isinstance(image, str):
            raise ValueError("Flux2ImageDefaultGo118 dependency must be an Image")
...
@Instance.register("fluxcd", "flux2_3653_to_3048")
class FLUX2_3653_TO_3048(Instance):
    ...
    def dependency(self) -> Image:
        return Flux2ImageDefaultGo118(self.pr, self._config)
