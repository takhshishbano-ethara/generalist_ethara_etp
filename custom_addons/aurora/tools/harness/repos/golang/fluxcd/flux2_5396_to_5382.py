"""fluxcd/flux2 config for PRs 5382-5396 (Go 1.24 era, Debian Bookworm)."""
...
class Flux2ImageBaseGo124(Image):
...
class Flux2ImageDefaultGo124(Image):
    def __init__(self, pr: PullRequest, config: Config):
        self._pr = pr
        self._config = config
    ...
    def dependency(self) -> Union[str, Image]:
        return Flux2ImageBaseGo124(self.pr, self.config)
...
""".format(repo=self.pr.repo),
    ...
    def dockerfile(self) -> str:
        ...
        if isinstance(image, str):
            raise ValueError("Flux2ImageDefaultGo124 dependency must be an Image")
...
@Instance.register("fluxcd", "flux2_5396_to_5382")
class FLUX2_5396_TO_5382(Instance):
    ...
    def dependency(self) -> Image:
        return Flux2ImageDefaultGo124(self.pr, self._config)
