...
class ContainerdImageBase(Image):
...
class ContainerdImageDefault(Image):
    def __init__(self, pr: PullRequest, config: Config):
        self._pr = pr
        self._config = config
    ...
    def dependency(self) -> Image | None:
        return ContainerdImageBase(self.pr, self.config)
...
@Instance.register("containerd", "containerd")
class Containerd(Instance):
    ...
    def dependency(self) -> Optional[Image]:
        return ContainerdImageDefault(self.pr, self._config)
