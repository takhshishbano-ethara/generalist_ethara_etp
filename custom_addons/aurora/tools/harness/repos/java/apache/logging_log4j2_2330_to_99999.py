...
class LoggingLog4j2Jdk17ImageBase(Image):
...
class LoggingLog4j2Jdk17ImageDefault(Image):
    def __init__(self, pr: PullRequest, config: Config):
        self._pr = pr
        self._config = config
    ...
    def dependency(self) -> Image | None:
        return LoggingLog4j2Jdk17ImageBase(self.pr, self._config)
...
# Install all modules to local repo first (ensures all inter-module dependencies are available)
...
@Instance.register("apache", "logging-log4j2_2330_to_99999")
class LoggingLog4j2Jdk17(Instance):
    ...
    def dependency(self) -> Optional[Image]:
        return LoggingLog4j2Jdk17ImageDefault(self.pr, self._config)
