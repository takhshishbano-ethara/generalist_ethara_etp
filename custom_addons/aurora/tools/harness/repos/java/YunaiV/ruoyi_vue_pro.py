...
class RuoyiVueProImageBase(Image):
    ...
    def dockerfile(self) -> str:
        ...
        return (
            ...
            '    fi\n'
            '\n'
            'ARG JDK_PKG="openjdk-17-jdk-headless"\n'
...
class RuoyiVueProImageDefault(Image):
    def __init__(self, pr: PullRequest, config: Config):
        self._pr = pr
        self._config = config
    ...
    def dependency(self) -> Image | None:
        return RuoyiVueProImageBase(self.pr, self._config)
...
@Instance.register("YunaiV", "ruoyi-vue-pro")
class RuoyiVuePro(Instance):
    ...
    def dependency(self) -> Optional[Image]:
        return RuoyiVueProImageDefault(self.pr, self._config)
