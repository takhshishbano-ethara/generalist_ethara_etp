...
class GuiceLateImageBase(Image):
...
class GuiceLateImageDefault(Image):
    def __init__(self, pr: PullRequest, config: Config):
        self._pr = pr
        self._config = config
    ...
    def dependency(self) -> Image | None:
        return GuiceLateImageBase(self.pr, self._config)
...
@Instance.register("google", "guice_1789_to_1906")
class Guice1789To1906(Instance):
    ...
    def dependency(self) -> Optional[Image]:
        return GuiceLateImageDefault(self.pr, self._config)
