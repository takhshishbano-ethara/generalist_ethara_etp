...
class GuiceEarlyImageBase(Image):
...
class GuiceEarlyImageDefault(Image):
    def __init__(self, pr: PullRequest, config: Config):
        self._pr = pr
        self._config = config
    ...
    def dependency(self) -> Image | None:
        return GuiceEarlyImageBase(self.pr, self._config)
...
@Instance.register("google", "guice_1086_to_1685")
class Guice1086To1685(Instance):
    ...
    def dependency(self) -> Optional[Image]:
        return GuiceEarlyImageDefault(self.pr, self._config)
