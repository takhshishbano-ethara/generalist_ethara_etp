...
bash /home/check_git_changes.sh
./gradlew clean testReleaseUnitTest --continue || true
""".format(pr=self.pr),
            ),
            File(
                ".",
...
cd /home/{pr.repo}
./gradlew clean testReleaseUnitTest --continue
...
@Instance.register("CatimaLoyalty", "Android")
class Android(Instance):
