...
# PR 5803 — waf 1.9.8 era (2018), requires ubuntu:18.04 (Python 3.6 / 2.7)
# waf 1.9.8 crashes on Python 3.7+ due to PEP 479 (StopIteration in generator)
...
@Instance.register("mpv-player", "mpv_5803")
class MPV_5803(Instance):
