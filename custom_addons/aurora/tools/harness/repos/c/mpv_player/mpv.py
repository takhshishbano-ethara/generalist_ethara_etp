...
# =============================================================================
# Default registry: meson-only PRs (13916, 13917, 16601, 16641, 16866)
# ubuntu:24.04, meson + ninja, libplacebo, FFmpeg >=6.x
#
...
class ImageBase(Image):
    """Meson-only mpv: ubuntu:24.04, meson>=1.3, libplacebo, FFmpeg 6.x+."""
...
# =============================================================================
# Instance — default handler for mpv-player/mpv (meson-only PRs with no interval)
# =============================================================================


@Instance.register("mpv-player", "mpv")
class Mpv(Instance):
    ...
    def parse_log(self, test_log: str) -> TestResult:
        ...
        #  1/13 chmap                       OK              0.01s
        #  2/13 gl-video                    FAIL            0.05s
        #  3/13 test-name                   SKIP            0.01s
        #  4/13 test-name                   EXPECTEDFAIL    0.02s
        #  5/13 test-name                   TIMEOUT         30.00s
