...
# PR 11495 — transitional meson+waf era (2023)
# ubuntu:22.04, meson>=0.62 via pip, libplacebo>=4.157, FFmpeg 4.x/5.x
...
@Instance.register("mpv-player", "mpv_11495")
class MPV_11495(Instance):
    ...
    def parse_log(self, test_log: str) -> TestResult:
        ...
        # Meson test output: "1/13 chmap  OK  0.01s"
