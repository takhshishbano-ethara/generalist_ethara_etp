...
class C_ARES_1053_TO_659_ImageBase(Image):
...
class C_ARES_1053_TO_659_ImageDefault(Image):
    def __init__(self, pr: PullRequest, config: Config):
        self._pr = pr
        self._config = config
    ...
    def dependency(self) -> Image | None:
        return C_ARES_1053_TO_659_ImageBase(self.pr, self.config)
...
@Instance.register("c-ares", "c_ares_1053_to_659")
class C_ARES_1053_TO_659(Instance):
    ...
    def dependency(self) -> Optional[Image]:
        return C_ARES_1053_TO_659_ImageDefault(self.pr, self._config)
