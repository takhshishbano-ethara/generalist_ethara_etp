...
class ReactSpringEra1ImageBase(Image):
...
class ReactSpringEra1ImageDefault(Image):
    def __init__(self, pr: PullRequest, config: Config):
        self._pr = pr
        self._config = config
    ...
    def dependency(self) -> Image | None:
        return ReactSpringEra1ImageBase(self.pr, self.config)
...
bash /home/check_git_changes.sh
yarn install --production=false || true
...
@Instance.register("pmndrs", "react_spring_375_to_114")
class ReactSpringEra1(Instance):
    ...
    def dependency(self) -> Optional[Image]:
        return ReactSpringEra1ImageDefault(self.pr, self._config)
