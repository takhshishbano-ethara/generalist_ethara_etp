...
class ImageBase12305To12119(Image):
...
class ImageDefault12305To12119(Image):
    def __init__(self, pr: PullRequest, config: Config):
        self._pr = pr
        self._config = config
    ...
    def dependency(self) -> Optional[Image]:
        return ImageBase12305To12119(self.pr, self.config)
...
@Instance.register("handsontable", "handsontable_12305_to_12119")
class HANDSONTABLE_12305_TO_12119(Instance):
    ...
    def dependency(self) -> Optional[Image]:
        return ImageDefault12305To12119(self.pr, self._config)
