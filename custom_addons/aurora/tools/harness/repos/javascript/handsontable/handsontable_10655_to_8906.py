...
class ImageBase10655To8906(Image):
...
class ImageDefault10655To8906(Image):
    def __init__(self, pr: PullRequest, config: Config):
        self._pr = pr
        self._config = config
    ...
    def dependency(self) -> Optional[Image]:
        return ImageBase10655To8906(self.pr, self.config)
...
@Instance.register("handsontable", "handsontable_10655_to_8906")
class HANDSONTABLE_10655_TO_8906(Instance):
    ...
    def dependency(self) -> Optional[Image]:
        return ImageDefault10655To8906(self.pr, self._config)
