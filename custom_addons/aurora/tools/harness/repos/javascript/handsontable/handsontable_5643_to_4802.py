...
class ImageBase5643To4802(Image):
...
class ImageDefault5643To4802(Image):
    def __init__(self, pr: PullRequest, config: Config):
        self._pr = pr
        self._config = config
    ...
    def dependency(self) -> Optional[Image]:
        return ImageBase5643To4802(self.pr, self.config)
...
cd /home/{pr.repo}
npx cross-env BABEL_ENV=commonjs npx env-cmd ./hot.config.js npx jest --verbose --no-coverage 2>&1 || true
...
@Instance.register("handsontable", "handsontable_5643_to_4802")
class HANDSONTABLE_5643_TO_4802(Instance):
    ...
    def dependency(self) -> Optional[Image]:
        return ImageDefault5643To4802(self.pr, self._config)
