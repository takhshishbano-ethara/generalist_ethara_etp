...
# PRs 20702, 20842, 21048, 21191, 21866, 22030, 22136, 22368, 22489, 22820, 22965, 23206, 23720, 23968, 24148, 24305, 24742, 24814
# Python 3.8 | setup.py
# Dependency signature: py:3.8-3.9||os:ubuntu-20.04||deps:setup.py+conda
...
""".format(test_files=test_files),
    ...
    def dockerfile(self) -> str:
        ...
        return f"""FROM python:3.8-slim-bookworm{global_env_block}
...
@Instance.register("numpy", "numpy_24814_to_20702")
class NUMPY_24814_TO_20702(Instance):
