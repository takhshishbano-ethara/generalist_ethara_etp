...
# PRs 16649, 16959, 17298, 17756 (maintenance/1.19.x only)
# PRs 18306, 18382, 18763 moved to numpy_18763_to_18306 (need Py3.7, numpy 1.20 dropped 3.6)
# Python 3.6 | setup.py
# Dependency signature: py:3.5-3.7||os:ubuntu-18.04||deps:setup.py
...
python -m pytest {test_files} --no-header -rA --tb=short -v --ignore=doc -p no:cacheprovider -c /dev/null -W "ignore::pytest.PytestUnknownMarkWarning" 2>&1
...
""".format(test_files=test_files),
    ...
    def dockerfile(self) -> str:
        ...
        return f"""FROM python:3.6-slim-buster{global_env_block}
...
@Instance.register("numpy", "numpy_18763_to_16649")
class NUMPY_18763_TO_16649(Instance):
