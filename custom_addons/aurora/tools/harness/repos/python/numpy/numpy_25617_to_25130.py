...
# PRs 25130, 25323, 25617
# Python 3.9 | setup.py + conda | ubuntu:22.04
# Dependency signature: py:3.8-3.9||os:ubuntu-latest||deps:conda+setup.py
# NOTE: numpy 1.26.x uses meson build system with editable installs that require ninja.
# We use non-editable install and site-packages test resolution (same as meson ranges).
...
@Instance.register("numpy", "numpy_25617_to_25130")
class NUMPY_25617_TO_25130(Instance):
