...
# PRs 29140, 29256, 29440, 29725, 29979
# Python 3.11 | meson | numpy 2.3.x (requires Python >=3.11)
...
""".format(resolve_prefix=resolve_prefix, test_args=resolved_test_args),
    ...
    def dockerfile(self) -> str:
        ...
        return f"""FROM python:3.11-slim-bookworm{global_env_block}
...
@Instance.register("numpy", "numpy_29979_to_29140")
class NUMPY_29979_TO_29140(Instance):
