...
# PRs 18306, 18382, 18763
# Python 3.7 | setup.py | buster
# numpy 1.20.x dropped Python 3.6, requires >= 3.7
...
@Instance.register("numpy", "numpy_18763_to_18306")
class NUMPY_18763_TO_18306(Instance):
