...
class ImageBase_10000_TO_99999(Image):
...
class ImageDefault_10000_TO_99999(Image):
    def __init__(self, pr: PullRequest, config: Config):
        self._pr = pr
        self._config = config
    ...
    def dependency(self) -> Image:
        return ImageBase_10000_TO_99999(self.pr, self.config)
...
""".format(
            ...
            File(
                ...
                """#!/bin/bash
cd /home/{pr.repo}
WANDB_DISABLED=true pytest -v --import-mode=importlib tests/ tests_v1/
...
@Instance.register("hiyouga", "LlamaFactory_10000_to_99999")
class LLAMAFACTORY_10000_TO_99999(Instance):
    ...
    def dependency(self) -> Optional[Image]:
        return ImageDefault_10000_TO_99999(self.pr, self._config)
