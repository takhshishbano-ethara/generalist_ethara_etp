...
###ACTION_DELIMITER###
echo 'pytest -rA --timeout=300 dask/array/tests/test_linalg.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_dataframe.py dask/tests/test_base.py' > test_commands.sh
###ACTION_DELIMITER###
...
cd /home/dask
EXISTING_FILES=""
for f in dask/array/tests/test_linalg.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_dataframe.py dask/tests/test_base.py; do
    if [ -f "$f" ]; then
...
pytest -rA --timeout=300 dask/array/tests/test_linalg.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_dataframe.py dask/tests/test_base.py
...
@Instance.register("dask", "dask_2023_11_0_to_2023_12_0")
class DASK_2023_11_0_TO_2023_12_0(Instance):
