...
###ACTION_DELIMITER###
echo 'pytest -rA --timeout=300 dask/array/tests/test_rechunk.py dask/bag/tests/test_bag.py dask/dataframe/io/tests/test_csv.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py dask/dataframe/tests/test_shuffle.py dask/tests/test_cli.py dask/tests/test_distributed.py dask/tests/test_highgraph.py dask/tests/test_utils.py' > test_commands.sh
###ACTION_DELIMITER###
...
cd /home/dask
EXISTING_FILES=""
for f in dask/array/tests/test_rechunk.py dask/bag/tests/test_bag.py dask/dataframe/io/tests/test_csv.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py dask/dataframe/tests/test_shuffle.py dask/tests/test_cli.py dask/tests/test_distributed.py dask/tests/test_highgraph.py dask/tests/test_utils.py; do
    if [ -f "$f" ]; then
...
pytest -rA --timeout=300 dask/array/tests/test_rechunk.py dask/bag/tests/test_bag.py dask/dataframe/io/tests/test_csv.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py dask/dataframe/tests/test_shuffle.py dask/tests/test_cli.py dask/tests/test_distributed.py dask/tests/test_highgraph.py dask/tests/test_utils.py
...
@Instance.register("dask", "dask_2023_6_0_to_2023_6_1")
class DASK_2023_6_0_TO_2023_6_1(Instance):
