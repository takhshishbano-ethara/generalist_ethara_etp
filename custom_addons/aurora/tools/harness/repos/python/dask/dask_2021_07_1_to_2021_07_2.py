...
###ACTION_DELIMITER###
echo 'pytest -rA --timeout=300 dask/array/tests/test_cupy.py dask/array/tests/test_routines.py dask/dataframe/io/tests/test_csv.py' > test_commands.sh
###ACTION_DELIMITER###
...
cd /home/dask
EXISTING_FILES=""
for f in dask/array/tests/test_cupy.py dask/array/tests/test_routines.py dask/dataframe/io/tests/test_csv.py; do
    if [ -f "$f" ]; then
...
pytest -rA --timeout=300 dask/array/tests/test_cupy.py dask/array/tests/test_routines.py dask/dataframe/io/tests/test_csv.py
...
@Instance.register("dask", "dask_2021_07_1_to_2021_07_2")
class DASK_2021_07_1_TO_2021_07_2(Instance):
