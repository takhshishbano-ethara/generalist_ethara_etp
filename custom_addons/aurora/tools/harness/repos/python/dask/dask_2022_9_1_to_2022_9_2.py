...
###ACTION_DELIMITER###
echo 'pytest -rA --timeout=300 dask/array/tests/test_array_core.py dask/array/tests/test_random.py dask/array/tests/test_rechunk.py dask/dataframe/tests/test_groupby.py dask/tests/test_distributed.py dask/tests/test_utils.py' > test_commands.sh
###ACTION_DELIMITER###
...
cd /home/dask
EXISTING_FILES=""
for f in dask/array/tests/test_array_core.py dask/array/tests/test_random.py dask/array/tests/test_rechunk.py dask/dataframe/tests/test_groupby.py dask/tests/test_distributed.py dask/tests/test_utils.py; do
    if [ -f "$f" ]; then
...
pytest -rA --timeout=300 dask/array/tests/test_array_core.py dask/array/tests/test_random.py dask/array/tests/test_rechunk.py dask/dataframe/tests/test_groupby.py dask/tests/test_distributed.py dask/tests/test_utils.py
...
@Instance.register("dask", "dask_2022_9_1_to_2022_9_2")
class DASK_2022_9_1_TO_2022_9_2(Instance):
