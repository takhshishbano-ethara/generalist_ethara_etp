...
###ACTION_DELIMITER###
echo 'pytest -rA --timeout=300 dask/array/tests/test_stats.py dask/array/tests/test_xarray.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_accessors.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py dask/dataframe/tests/test_rolling.py dask/tests/test_backends.py dask/tests/test_base.py dask/tests/test_delayed.py dask/tests/test_distributed.py dask/tests/test_spark_compat.py dask/tests/test_typing.py' > test_commands.sh
###ACTION_DELIMITER###
...
cd /home/dask
EXISTING_FILES=""
for f in dask/array/tests/test_stats.py dask/array/tests/test_xarray.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_accessors.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py dask/dataframe/tests/test_rolling.py dask/tests/test_backends.py dask/tests/test_base.py dask/tests/test_delayed.py dask/tests/test_distributed.py dask/tests/test_spark_compat.py dask/tests/test_typing.py; do
    if [ -f "$f" ]; then
...
pytest -rA --timeout=300 dask/array/tests/test_stats.py dask/array/tests/test_xarray.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_accessors.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py dask/dataframe/tests/test_rolling.py dask/tests/test_backends.py dask/tests/test_base.py dask/tests/test_delayed.py dask/tests/test_distributed.py dask/tests/test_spark_compat.py dask/tests/test_typing.py
...
@Instance.register("dask", "dask_2022_11_1_to_2022_12_0")
class DASK_2022_11_1_TO_2022_12_0(Instance):
