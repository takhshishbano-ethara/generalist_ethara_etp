...
###ACTION_DELIMITER###
echo 'pytest -rA --timeout=300 dask/array/tests/test_reductions.py dask/dataframe/io/tests/test_csv.py dask/dataframe/io/tests/test_json.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_merge_column_and_index.py dask/dataframe/tests/test_multi.py dask/tests/test_config.py' > test_commands.sh
###ACTION_DELIMITER###
...
cd /home/dask
EXISTING_FILES=""
for f in dask/array/tests/test_reductions.py dask/dataframe/io/tests/test_csv.py dask/dataframe/io/tests/test_json.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_merge_column_and_index.py dask/dataframe/tests/test_multi.py dask/tests/test_config.py; do
    if [ -f "$f" ]; then
...
pytest -rA --timeout=300 dask/array/tests/test_reductions.py dask/dataframe/io/tests/test_csv.py dask/dataframe/io/tests/test_json.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_merge_column_and_index.py dask/dataframe/tests/test_multi.py dask/tests/test_config.py
...
@Instance.register("dask", "dask_2023_9_2_to_2023_9_3")
class DASK_2023_9_2_TO_2023_9_3(Instance):
