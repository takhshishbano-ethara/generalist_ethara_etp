...
###ACTION_DELIMITER###
echo 'pytest -rA --timeout=300 dask/bag/tests/test_bag.py dask/dataframe/io/tests/test_csv.py dask/dataframe/io/tests/test_parquet.py dask/tests/test_order.py' > test_commands.sh
###ACTION_DELIMITER###
...
cd /home/dask
EXISTING_FILES=""
for f in dask/bag/tests/test_bag.py dask/dataframe/io/tests/test_csv.py dask/dataframe/io/tests/test_parquet.py dask/tests/test_order.py; do
    if [ -f "$f" ]; then
...
pytest -rA --timeout=300 dask/bag/tests/test_bag.py dask/dataframe/io/tests/test_csv.py dask/dataframe/io/tests/test_parquet.py dask/tests/test_order.py
...
@Instance.register("dask", "dask_2023_9_3_to_2023_10_0")
class DASK_2023_9_3_TO_2023_10_0(Instance):
