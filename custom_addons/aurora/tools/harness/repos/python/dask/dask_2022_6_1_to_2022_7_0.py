...
###ACTION_DELIMITER###
echo 'pytest -rA --timeout=300 dask/array/tests/test_array_core.py dask/dataframe/tests/test_categorical.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_multi.py dask/dataframe/tests/test_rolling.py dask/tests/test_base.py dask/tests/test_distributed.py dask/tests/test_sizeof.py dask/tests/test_typing.py' > test_commands.sh
###ACTION_DELIMITER###
...
cd /home/dask
EXISTING_FILES=""
for f in dask/array/tests/test_array_core.py dask/dataframe/tests/test_categorical.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_multi.py dask/dataframe/tests/test_rolling.py dask/tests/test_base.py dask/tests/test_distributed.py dask/tests/test_sizeof.py dask/tests/test_typing.py; do
    if [ -f "$f" ]; then
...
pytest -rA --timeout=300 dask/array/tests/test_array_core.py dask/dataframe/tests/test_categorical.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_multi.py dask/dataframe/tests/test_rolling.py dask/tests/test_base.py dask/tests/test_distributed.py dask/tests/test_sizeof.py dask/tests/test_typing.py
...
@Instance.register("dask", "dask_2022_6_1_to_2022_7_0")
class DASK_2022_6_1_TO_2022_7_0(Instance):
