...
###ACTION_DELIMITER###
echo 'pytest -rA --timeout=300 dask/array/tests/test_array_core.py dask/bag/tests/test_bag.py dask/dataframe/tests/test_shuffle.py' > test_commands.sh
###ACTION_DELIMITER###
...
cd /home/dask
EXISTING_FILES=""
for f in dask/array/tests/test_array_core.py dask/bag/tests/test_bag.py dask/dataframe/tests/test_shuffle.py; do
    if [ -f "$f" ]; then
...
pytest -rA --timeout=300 dask/array/tests/test_array_core.py dask/bag/tests/test_bag.py dask/dataframe/tests/test_shuffle.py
...
@Instance.register("dask", "dask_2024_4_1_to_2024_4_2")
class DASK_2024_4_1_TO_2024_4_2(Instance):
