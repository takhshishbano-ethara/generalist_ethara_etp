...
###ACTION_DELIMITER###
echo 'pytest -rA --timeout=300 dask/array/tests/test_cupy_percentile.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py dask/dataframe/tests/test_rolling.py dask/tests/test_cli.py dask/tests/test_config.py dask/tests/test_docs.py dask/tests/test_tokenize.py' > test_commands.sh
###ACTION_DELIMITER###
...
cd /home/dask
EXISTING_FILES=""
for f in dask/array/tests/test_cupy_percentile.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py dask/dataframe/tests/test_rolling.py dask/tests/test_cli.py dask/tests/test_config.py dask/tests/test_docs.py dask/tests/test_tokenize.py; do
    if [ -f "$f" ]; then
...
pytest -rA --timeout=300 dask/array/tests/test_cupy_percentile.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py dask/dataframe/tests/test_rolling.py dask/tests/test_cli.py dask/tests/test_config.py dask/tests/test_docs.py dask/tests/test_tokenize.py
...
@Instance.register("dask", "dask_2024_2_0_to_2024_2_1")
class DASK_2024_2_0_TO_2024_2_1(Instance):
