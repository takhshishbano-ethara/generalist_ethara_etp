...
###ACTION_DELIMITER###
echo 'pytest -rA --timeout=300 dask/array/tests/test_creation.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_groupby.py dask/tests/test_base.py dask/tests/test_dot.py' > test_commands.sh
###ACTION_DELIMITER###
...
cd /home/dask
EXISTING_FILES=""
for f in dask/array/tests/test_creation.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_groupby.py dask/tests/test_base.py dask/tests/test_dot.py; do
    if [ -f "$f" ]; then
...
pytest -rA --timeout=300 dask/array/tests/test_creation.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_groupby.py dask/tests/test_base.py dask/tests/test_dot.py
...
@Instance.register("dask", "dask_2022_05_1_to_2022_05_2")
class DASK_2022_05_1_TO_2022_05_2(Instance):
