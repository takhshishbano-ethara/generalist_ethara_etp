...
###ACTION_DELIMITER###
echo 'pytest -rA --timeout=300 dask/array/tests/test_cupy_core.py dask/array/tests/test_cupy_linalg.py dask/array/tests/test_cupy_overlap.py dask/array/tests/test_cupy_routines.py dask/array/tests/test_linalg.py dask/array/tests/test_sparse.py dask/array/tests/test_stats.py dask/bytes/tests/test_http.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_accessors.py dask/dataframe/tests/test_reshape.py dask/tests/test_compatibility.py dask/tests/test_sizeof.py dask/tests/test_tokenize.py' > test_commands.sh
###ACTION_DELIMITER###
...
cd /home/dask
EXISTING_FILES=""
for f in dask/array/tests/test_cupy_core.py dask/array/tests/test_cupy_linalg.py dask/array/tests/test_cupy_overlap.py dask/array/tests/test_cupy_routines.py dask/array/tests/test_linalg.py dask/array/tests/test_sparse.py dask/array/tests/test_stats.py dask/bytes/tests/test_http.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_accessors.py dask/dataframe/tests/test_reshape.py dask/tests/test_compatibility.py dask/tests/test_sizeof.py dask/tests/test_tokenize.py; do
    if [ -f "$f" ]; then
...
pytest -rA --timeout=300 dask/array/tests/test_cupy_core.py dask/array/tests/test_cupy_linalg.py dask/array/tests/test_cupy_overlap.py dask/array/tests/test_cupy_routines.py dask/array/tests/test_linalg.py dask/array/tests/test_sparse.py dask/array/tests/test_stats.py dask/bytes/tests/test_http.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_accessors.py dask/dataframe/tests/test_reshape.py dask/tests/test_compatibility.py dask/tests/test_sizeof.py dask/tests/test_tokenize.py
...
@Instance.register("dask", "dask_2024_5_2_to_2024_6_0")
class DASK_2024_5_2_TO_2024_6_0(Instance):
