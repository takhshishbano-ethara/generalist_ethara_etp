...
###ACTION_DELIMITER###
echo 'pytest -rA --timeout=300 dask/dataframe/tests/test_groupby.py dask/tests/test_layers.py dask/tests/test_utils.py' > test_commands.sh
###ACTION_DELIMITER###
...
cd /home/dask
EXISTING_FILES=""
for f in dask/dataframe/tests/test_groupby.py dask/tests/test_layers.py dask/tests/test_utils.py; do
    if [ -f "$f" ]; then
...
pytest -rA --timeout=300 dask/dataframe/tests/test_groupby.py dask/tests/test_layers.py dask/tests/test_utils.py
...
@Instance.register("dask", "dask_2022_8_1_to_2022_9_0")
class DASK_2022_8_1_TO_2022_9_0(Instance):
