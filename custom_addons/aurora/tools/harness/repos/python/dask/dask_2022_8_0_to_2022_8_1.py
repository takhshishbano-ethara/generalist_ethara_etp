...
###ACTION_DELIMITER###
echo 'pytest -rA --timeout=300 dask/array/tests/test_atop.py dask/array/tests/test_masked.py dask/array/tests/test_reductions.py dask/array/tests/test_sparse.py dask/bag/tests/test_random.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py dask/dataframe/tests/test_shuffle.py dask/dataframe/tests/test_utils_dataframe.py dask/tests/test_base.py dask/tests/test_compatibility.py dask/tests/test_delayed.py' > test_commands.sh
###ACTION_DELIMITER###
...
cd /home/dask
EXISTING_FILES=""
for f in dask/array/tests/test_atop.py dask/array/tests/test_masked.py dask/array/tests/test_reductions.py dask/array/tests/test_sparse.py dask/bag/tests/test_random.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py dask/dataframe/tests/test_shuffle.py dask/dataframe/tests/test_utils_dataframe.py dask/tests/test_base.py dask/tests/test_compatibility.py dask/tests/test_delayed.py; do
    if [ -f "$f" ]; then
...
pytest -rA --timeout=300 dask/array/tests/test_atop.py dask/array/tests/test_masked.py dask/array/tests/test_reductions.py dask/array/tests/test_sparse.py dask/bag/tests/test_random.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py dask/dataframe/tests/test_shuffle.py dask/dataframe/tests/test_utils_dataframe.py dask/tests/test_base.py dask/tests/test_compatibility.py dask/tests/test_delayed.py
...
@Instance.register("dask", "dask_2022_8_0_to_2022_8_1")
class DASK_2022_8_0_TO_2022_8_1(Instance):
