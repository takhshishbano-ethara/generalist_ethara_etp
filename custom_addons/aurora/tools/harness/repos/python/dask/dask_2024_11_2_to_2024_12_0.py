...
###ACTION_DELIMITER###
echo 'pytest -rA --timeout=300 dask/array/tests/test_array_core.py dask/array/tests/test_atop.py dask/array/tests/test_map_blocks.py dask/array/tests/test_optimization.py dask/array/tests/test_overlap.py dask/array/tests/test_rechunk.py dask/array/tests/test_reductions.py dask/array/tests/test_reshape.py dask/array/tests/test_shuffle.py dask/array/tests/test_slicing.py dask/bag/tests/test_bag.py dask/dataframe/io/tests/test_orc.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_dataframe.py dask/tests/test_base.py dask/tests/test_distributed.py dask/tests/test_highgraph.py dask/tests/test_order.py dask/tests/test_task_spec.py dask/tests/test_tokenize.py' > test_commands.sh
###ACTION_DELIMITER###
...
@Instance.register("dask", "dask_2024_11_2_to_2024_12_0")
class DASK_2024_11_2_TO_2024_12_0(Instance):
