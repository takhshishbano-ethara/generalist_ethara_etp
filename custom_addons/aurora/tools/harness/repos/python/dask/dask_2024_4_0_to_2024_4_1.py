...
###ACTION_DELIMITER###
echo 'pytest -rA --timeout=300 dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py' > test_commands.sh
###ACTION_DELIMITER###
...
cd /home/dask
EXISTING_FILES=""
for f in dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py; do
    if [ -f "$f" ]; then
...
pytest -rA --timeout=300 dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py
...
@Instance.register("dask", "dask_2024_4_0_to_2024_4_1")
class DASK_2024_4_0_TO_2024_4_1(Instance):
