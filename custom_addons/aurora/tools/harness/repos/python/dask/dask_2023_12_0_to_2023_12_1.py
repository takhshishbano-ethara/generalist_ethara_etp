...
###ACTION_DELIMITER###
echo 'pytest -rA --timeout=300 dask/array/tests/test_array_core.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py dask/dataframe/tests/test_indexing.py dask/dataframe/tests/test_shuffle.py dask/dataframe/tests/test_ufunc.py dask/tests/test_base.py dask/tests/test_delayed.py dask/tests/test_local.py dask/tests/test_optimization.py dask/tests/test_order.py' > test_commands.sh
###ACTION_DELIMITER###
...
cd /home/dask
EXISTING_FILES=""
for f in dask/array/tests/test_array_core.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py dask/dataframe/tests/test_indexing.py dask/dataframe/tests/test_shuffle.py dask/dataframe/tests/test_ufunc.py dask/tests/test_base.py dask/tests/test_delayed.py dask/tests/test_local.py dask/tests/test_optimization.py dask/tests/test_order.py; do
    if [ -f "$f" ]; then
...
pytest -rA --timeout=300 dask/array/tests/test_array_core.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py dask/dataframe/tests/test_indexing.py dask/dataframe/tests/test_shuffle.py dask/dataframe/tests/test_ufunc.py dask/tests/test_base.py dask/tests/test_delayed.py dask/tests/test_local.py dask/tests/test_optimization.py dask/tests/test_order.py
...
@Instance.register("dask", "dask_2023_12_0_to_2023_12_1")
class DASK_2023_12_0_TO_2023_12_1(Instance):
