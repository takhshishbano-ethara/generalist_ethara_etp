...
###ACTION_DELIMITER###
echo 'pytest -rA --timeout=300 dask/array/tests/test_array_function.py dask/dataframe/io/tests/test_csv.py dask/dataframe/tests/test_groupby.py' > test_commands.sh
###ACTION_DELIMITER###
...
cd /home/dask
EXISTING_FILES=""
for f in dask/array/tests/test_array_function.py dask/dataframe/io/tests/test_csv.py dask/dataframe/tests/test_groupby.py; do
    if [ -f "$f" ]; then
...
pytest -rA --timeout=300 dask/array/tests/test_array_function.py dask/dataframe/io/tests/test_csv.py dask/dataframe/tests/test_groupby.py
...
@Instance.register("dask", "dask_2024_5_1_to_2024_5_2")
class DASK_2024_5_1_TO_2024_5_2(Instance):
