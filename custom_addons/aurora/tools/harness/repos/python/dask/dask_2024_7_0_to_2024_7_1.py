...
###ACTION_DELIMITER###
echo 'pytest -rA --timeout=300 dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_utils_dataframe.py dask/dataframe/tseries/tests/test_resample.py' > test_commands.sh
###ACTION_DELIMITER###
...
cd /home/dask
EXISTING_FILES=""
for f in dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_utils_dataframe.py dask/dataframe/tseries/tests/test_resample.py; do
    if [ -f "$f" ]; then
...
pytest -rA --timeout=300 dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_utils_dataframe.py dask/dataframe/tseries/tests/test_resample.py
...
@Instance.register("dask", "dask_2024_7_0_to_2024_7_1")
class DASK_2024_7_0_TO_2024_7_1(Instance):
