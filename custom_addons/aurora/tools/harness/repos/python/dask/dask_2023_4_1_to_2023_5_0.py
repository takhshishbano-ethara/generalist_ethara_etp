...
###ACTION_DELIMITER###
echo 'pytest -rA --timeout=300 dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_arithmetics_reduction.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py dask/tests/test_graph_manipulation.py' > test_commands.sh
###ACTION_DELIMITER###
...
cd /home/dask
EXISTING_FILES=""
for f in dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_arithmetics_reduction.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py dask/tests/test_graph_manipulation.py; do
    if [ -f "$f" ]; then
...
pytest -rA --timeout=300 dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_arithmetics_reduction.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py dask/tests/test_graph_manipulation.py
...
@Instance.register("dask", "dask_2023_4_1_to_2023_5_0")
class DASK_2023_4_1_TO_2023_5_0(Instance):
