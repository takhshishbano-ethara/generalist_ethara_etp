...
cd /home/dask
EXISTING_FILES=""
for f in dask/array/tests/test_array_core.py dask/dataframe/tests/test_shuffle.py dask/tests/test_base.py dask/tests/test_config.py dask/tests/test_core.py dask/tests/test_graph_manipulation.py dask/tests/test_layers.py dask/tests/test_typing.py dask/tests/test_utils.py; do
    if [ -f "$f" ]; then
...
pytest -rA --timeout=300 dask/array/tests/test_array_core.py dask/dataframe/tests/test_shuffle.py dask/tests/test_base.py dask/tests/test_config.py dask/tests/test_core.py dask/tests/test_graph_manipulation.py dask/tests/test_layers.py dask/tests/test_typing.py dask/tests/test_utils.py
...
@Instance.register("dask", "dask_2023_9_0_to_2023_9_1")
class DASK_2023_9_0_TO_2023_9_1(Instance):
