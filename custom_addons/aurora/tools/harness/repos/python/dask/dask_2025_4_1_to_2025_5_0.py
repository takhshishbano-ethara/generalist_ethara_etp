...
###ACTION_DELIMITER###
echo 'pytest -rA --timeout=300 dask/array/tests/test_slicing.py dask/dataframe/dask_expr/io/tests/test_parquet.py dask/dataframe/dask_expr/tests/test_distributed.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_dataframe.py dask/tests/test_distributed.py dask/tests/test_layers.py dask/tests/test_local.py dask/tests/test_order.py dask/tests/test_task_spec.py' > test_commands.sh
###ACTION_DELIMITER###
...
cd /home/dask
EXISTING_FILES=""
for f in dask/array/tests/test_slicing.py dask/dataframe/dask_expr/io/tests/test_parquet.py dask/dataframe/dask_expr/tests/test_distributed.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_dataframe.py dask/tests/test_distributed.py dask/tests/test_layers.py dask/tests/test_local.py dask/tests/test_order.py dask/tests/test_task_spec.py; do
    if [ -f "$f" ]; then
...
pytest -rA --timeout=300 dask/array/tests/test_slicing.py dask/dataframe/dask_expr/io/tests/test_parquet.py dask/dataframe/dask_expr/tests/test_distributed.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_dataframe.py dask/tests/test_distributed.py dask/tests/test_layers.py dask/tests/test_local.py dask/tests/test_order.py dask/tests/test_task_spec.py
...
@Instance.register("dask", "dask_2025_4_1_to_2025_5_0")
class DASK_2025_4_1_TO_2025_5_0(Instance):
