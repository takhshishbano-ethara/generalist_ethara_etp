...
###ACTION_DELIMITER###
echo 'pytest -rA --timeout=300 dask/dataframe/io/tests/test_csv.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py dask/tests/test_system.py' > test_commands.sh
###ACTION_DELIMITER###
...
cd /home/dask
EXISTING_FILES=""
for f in dask/dataframe/io/tests/test_csv.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py dask/tests/test_system.py; do
    if [ -f "$f" ]; then
...
pytest -rA --timeout=300 dask/dataframe/io/tests/test_csv.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py dask/tests/test_system.py
...
@Instance.register("dask", "dask_2023_8_0_to_2023_8_1")
class DASK_2023_8_0_TO_2023_8_1(Instance):
