...
###ACTION_DELIMITER###
echo 'pytest -rA --timeout=300 dask/array/tests/test_array_core.py dask/array/tests/test_overlap.py dask/array/tests/test_reductions.py dask/array/tests/test_sparse.py dask/array/tests/test_ufunc.py dask/bytes/tests/test_http.py dask/dataframe/io/tests/test_csv.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py dask/dataframe/tests/test_shuffle.py dask/diagnostics/tests/test_profiler.py dask/tests/test_base.py dask/tests/test_layers.py' > test_commands.sh
###ACTION_DELIMITER###
...
cd /home/dask
EXISTING_FILES=""
for f in dask/array/tests/test_array_core.py dask/array/tests/test_overlap.py dask/array/tests/test_reductions.py dask/array/tests/test_sparse.py dask/array/tests/test_ufunc.py dask/bytes/tests/test_http.py dask/dataframe/io/tests/test_csv.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py dask/dataframe/tests/test_shuffle.py dask/diagnostics/tests/test_profiler.py dask/tests/test_base.py dask/tests/test_layers.py; do
    if [ -f "$f" ]; then
...
pytest -rA --timeout=300 dask/array/tests/test_array_core.py dask/array/tests/test_overlap.py dask/array/tests/test_reductions.py dask/array/tests/test_sparse.py dask/array/tests/test_ufunc.py dask/bytes/tests/test_http.py dask/dataframe/io/tests/test_csv.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py dask/dataframe/tests/test_shuffle.py dask/diagnostics/tests/test_profiler.py dask/tests/test_base.py dask/tests/test_layers.py
...
@Instance.register("dask", "dask_2021_11_2_to_2021_12_0")
class DASK_2021_11_2_TO_2021_12_0(Instance):
