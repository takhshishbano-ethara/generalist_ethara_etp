...
cd /home/dask
EXISTING_FILES=""
for f in dask/array/tests/test_array_core.py dask/array/tests/test_array_expr_incompatible.py dask/dataframe/io/tests/test_csv.py dask/dataframe/io/tests/test_demo.py dask/dataframe/io/tests/test_hdf.py dask/dataframe/io/tests/test_io.py dask/dataframe/io/tests/test_json.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_accessors.py dask/dataframe/tests/test_arithmetics_reduction.py dask/dataframe/tests/test_categorical.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py dask/dataframe/tests/test_methods.py dask/dataframe/tests/test_multi.py dask/dataframe/tests/test_pyarrow.py dask/dataframe/tests/test_pyarrow_compat.py dask/dataframe/tests/test_reshape.py dask/dataframe/tests/test_rolling.py dask/dataframe/tests/test_shuffle.py dask/dataframe/tests/test_utils_dataframe.py dask/tests/test_sizeof.py dask/tests/test_spark_compat.py; do
    if [ -f "$f" ]; then
...
pytest -rA --timeout=300 dask/array/tests/test_array_core.py dask/array/tests/test_array_expr_incompatible.py dask/dataframe/io/tests/test_csv.py dask/dataframe/io/tests/test_demo.py dask/dataframe/io/tests/test_hdf.py dask/dataframe/io/tests/test_io.py dask/dataframe/io/tests/test_json.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_accessors.py dask/dataframe/tests/test_arithmetics_reduction.py dask/dataframe/tests/test_categorical.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py dask/dataframe/tests/test_methods.py dask/dataframe/tests/test_multi.py dask/dataframe/tests/test_pyarrow.py dask/dataframe/tests/test_pyarrow_compat.py dask/dataframe/tests/test_reshape.py dask/dataframe/tests/test_rolling.py dask/dataframe/tests/test_shuffle.py dask/dataframe/tests/test_utils_dataframe.py dask/tests/test_sizeof.py dask/tests/test_spark_compat.py
...
@Instance.register("dask", "dask_2024_6_2_to_2024_7_0")
class DASK_2024_6_2_TO_2024_7_0(Instance):
