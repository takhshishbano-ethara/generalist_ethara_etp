...
###ACTION_DELIMITER###
echo 'pytest -rA --timeout=300 dask/array/tests/test_routines.py dask/array/tests/test_slicing.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_reshape.py dask/diagnostics/tests/test_profiler.py dask/tests/test_core.py dask/tests/test_distributed.py dask/tests/test_layers.py' > test_commands.sh
###ACTION_DELIMITER###
...
cd /home/dask
EXISTING_FILES=""
for f in dask/array/tests/test_routines.py dask/array/tests/test_slicing.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_reshape.py dask/diagnostics/tests/test_profiler.py dask/tests/test_core.py dask/tests/test_distributed.py dask/tests/test_layers.py; do
    if [ -f "$f" ]; then
...
pytest -rA --timeout=300 dask/array/tests/test_routines.py dask/array/tests/test_slicing.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_reshape.py dask/diagnostics/tests/test_profiler.py dask/tests/test_core.py dask/tests/test_distributed.py dask/tests/test_layers.py
...
@Instance.register("dask", "dask_2022_7_0_to_2022_7_1")
class DASK_2022_7_0_TO_2022_7_1(Instance):
