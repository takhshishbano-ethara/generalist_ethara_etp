...
###ACTION_DELIMITER###
echo 'pytest -rA --timeout=300 dask/array/tests/test_reductions.py dask/dataframe/tests/test_utils_dataframe.py dask/tests/test_task_spec.py' > test_commands.sh
###ACTION_DELIMITER###
...
cd /home/dask
EXISTING_FILES=""
for f in dask/array/tests/test_reductions.py dask/dataframe/tests/test_utils_dataframe.py dask/tests/test_task_spec.py; do
    if [ -f "$f" ]; then
...
pytest -rA --timeout=300 dask/array/tests/test_reductions.py dask/dataframe/tests/test_utils_dataframe.py dask/tests/test_task_spec.py
...
@Instance.register("dask", "dask_2024_11_1_to_2024_11_2")
class DASK_2024_11_1_TO_2024_11_2(Instance):
