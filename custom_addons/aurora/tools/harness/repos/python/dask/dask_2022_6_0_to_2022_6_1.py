...
###ACTION_DELIMITER###
echo 'pytest -rA --timeout=300 dask/array/tests/test_overlap.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_ufunc.py dask/diagnostics/tests/test_progress.py dask/tests/test_base.py dask/tests/test_utils.py' > test_commands.sh
###ACTION_DELIMITER###
...
cd /home/dask
EXISTING_FILES=""
for f in dask/array/tests/test_overlap.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_ufunc.py dask/diagnostics/tests/test_progress.py dask/tests/test_base.py dask/tests/test_utils.py; do
    if [ -f "$f" ]; then
...
pytest -rA --timeout=300 dask/array/tests/test_overlap.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_ufunc.py dask/diagnostics/tests/test_progress.py dask/tests/test_base.py dask/tests/test_utils.py
...
@Instance.register("dask", "dask_2022_6_0_to_2022_6_1")
class DASK_2022_6_0_TO_2022_6_1(Instance):
