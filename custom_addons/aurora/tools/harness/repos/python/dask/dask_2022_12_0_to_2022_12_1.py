...
###ACTION_DELIMITER###
echo 'pytest -rA --timeout=300 dask/dataframe/io/tests/test_hdf.py dask/dataframe/io/tests/test_io.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py dask/dataframe/tests/test_pyarrow_compat.py dask/tests/test_ci.py dask/tests/test_dot.py dask/tests/test_spark_compat.py' > test_commands.sh
###ACTION_DELIMITER###
...
cd /home/dask
EXISTING_FILES=""
for f in dask/dataframe/io/tests/test_hdf.py dask/dataframe/io/tests/test_io.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py dask/dataframe/tests/test_pyarrow_compat.py dask/tests/test_ci.py dask/tests/test_dot.py dask/tests/test_spark_compat.py; do
    if [ -f "$f" ]; then
...
pytest -rA --timeout=300 dask/dataframe/io/tests/test_hdf.py dask/dataframe/io/tests/test_io.py dask/dataframe/io/tests/test_parquet.py dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py dask/dataframe/tests/test_pyarrow_compat.py dask/tests/test_ci.py dask/tests/test_dot.py dask/tests/test_spark_compat.py
...
@Instance.register("dask", "dask_2022_12_0_to_2022_12_1")
class DASK_2022_12_0_TO_2022_12_1(Instance):
