...
###ACTION_DELIMITER###
echo 'pytest -rA --timeout=300 dask/array/tests/test_slicing.py dask/array/tests/test_xarray.py' > test_commands.sh
###ACTION_DELIMITER###
...
cd /home/dask
EXISTING_FILES=""
for f in dask/array/tests/test_slicing.py dask/array/tests/test_xarray.py; do
    if [ -f "$f" ]; then
...
pytest -rA --timeout=300 dask/array/tests/test_slicing.py dask/array/tests/test_xarray.py
...
@Instance.register("dask", "dask_2025_5_0_to_2025_5_1")
class DASK_2025_5_0_TO_2025_5_1(Instance):
