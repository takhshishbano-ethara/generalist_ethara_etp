...
###ACTION_DELIMITER###
echo 'pytest -rA --timeout=300 dask/array/tests/test_array_core.py dask/array/tests/test_overlap.py dask/dataframe/io/tests/test_csv.py dask/tests/test_task_spec.py' > test_commands.sh
###ACTION_DELIMITER###
...
cd /home/dask
EXISTING_FILES=""
for f in dask/array/tests/test_array_core.py dask/array/tests/test_overlap.py dask/dataframe/io/tests/test_csv.py dask/tests/test_task_spec.py; do
    if [ -f "$f" ]; then
...
pytest -rA --timeout=300 dask/array/tests/test_array_core.py dask/array/tests/test_overlap.py dask/dataframe/io/tests/test_csv.py dask/tests/test_task_spec.py
...
@Instance.register("dask", "dask_2024_12_0_to_2024_12_1")
class DASK_2024_12_0_TO_2024_12_1(Instance):
