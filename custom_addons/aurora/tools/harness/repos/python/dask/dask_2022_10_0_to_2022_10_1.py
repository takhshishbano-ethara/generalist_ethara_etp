...
###ACTION_DELIMITER###
echo 'pytest -rA --timeout=300 continuous_integration/scripts/test_imports.sh dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py dask/dataframe/tests/test_multi.py dask/dataframe/tests/test_shuffle.py dask/tests/test_cli.py' > test_commands.sh
###ACTION_DELIMITER###
...
cd /home/dask
EXISTING_FILES=""
for f in continuous_integration/scripts/test_imports.sh dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py dask/dataframe/tests/test_multi.py dask/dataframe/tests/test_shuffle.py dask/tests/test_cli.py; do
    if [ -f "$f" ]; then
...
pytest -rA --timeout=300 continuous_integration/scripts/test_imports.sh dask/dataframe/tests/test_dataframe.py dask/dataframe/tests/test_groupby.py dask/dataframe/tests/test_multi.py dask/dataframe/tests/test_shuffle.py dask/tests/test_cli.py
...
@Instance.register("dask", "dask_2022_10_0_to_2022_10_1")
class DASK_2022_10_0_TO_2022_10_1(Instance):
