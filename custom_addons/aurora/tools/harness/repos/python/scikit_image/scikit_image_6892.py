...
###ACTION_DELIMITER###
pip install ninja meson 'meson-python>=0.15' 'Cython==3.0.10' wheel 'setuptools>=67' packaging 'numpy<2' pythran 'lazy_loader>=0.3'
###ACTION_DELIMITER###
...
RUN pip install ninja meson 'meson-python>=0.15' 'Cython==3.0.10' wheel 'setuptools>=67' packaging 'numpy<2' pythran 'lazy_loader>=0.3'
...
@Instance.register("scikit-image", "scikit_image_6892")
class SCIKIT_IMAGE_6892(Instance):
