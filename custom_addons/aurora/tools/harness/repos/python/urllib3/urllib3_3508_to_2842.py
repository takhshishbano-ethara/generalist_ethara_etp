...
###ACTION_DELIMITER###
pip install -e ".[socks,brotli,zstd]" && pip install -r dev-requirements.txt && pip install pytest-xdist
###ACTION_DELIMITER###
pytest --version""",
            ),
            File(
...
RUN pip install -e ".[socks,brotli,zstd]" && pip install -r dev-requirements.txt && pip install pytest-xdist || true
"""
...
@Instance.register("urllib3", "urllib3_3508_to_2842")
class Urllib3_3508_to_2842(Instance):
    ...
    def dependency(self) -> Optional[Image]:
        return Urllib3HatchImage(self.pr, self._config)
