    ...
    def files(self) -> list[File]:
        return [
            ...
            File(
                ...
                """ls -la
###ACTION_DELIMITER###
apt-get update && apt-get install -y libssl-dev libbrotli-dev libzstd-dev curl
###ACTION_DELIMITER###
pip install uv
###ACTION_DELIMITER###
...
RUN pip install uv && uv sync --frozen --group dev && uv pip install pytest-xdist || true
"""
...
@Instance.register("urllib3", "urllib3_3736_to_3592")
class Urllib3_3736_to_3592(Instance):
    ...
    def dependency(self) -> Optional[Image]:
        return Urllib3UvImage(self.pr, self._config)
