...
# PRs: [459, 462, 1303, 1339, 1371, 1413, 1450, 1506, 1531, 1572, 1590, 1677, 1707, 1714, 1715, 1717, 1781, 1792, 1839, 1841, 1919, 2004, 2027, 2039, 2154, 2215, 2329, 2384, 2455, 2602]
# Python 3.5 | pip + setup.py | ubuntu:22.04
...
"""),
    ...
    def dockerfile(self) -> str:
        ...
        return f"""FROM python:3.8-slim-bookworm
...
@Instance.register("pre-commit", "pre-commit_2602_to_459")
class PreCommit2602To459(Instance):
