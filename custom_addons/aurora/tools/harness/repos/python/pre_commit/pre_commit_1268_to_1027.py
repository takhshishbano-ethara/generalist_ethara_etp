...
# PRs: [1027, 1054, 1116, 1124, 1195, 1200, 1268]
# Python 2.7 | pip + setup.py | ubuntu:22.04
...
@Instance.register("pre-commit", "pre-commit_1268_to_1027")
class PreCommit1268To1027(Instance):
