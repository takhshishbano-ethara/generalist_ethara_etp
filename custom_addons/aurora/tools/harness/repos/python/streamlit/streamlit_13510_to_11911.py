...
class ImageDefault_13510_11911(Image):
...
@Instance.register("streamlit", "streamlit_13510_to_11911")
class STREAMLIT_13510_TO_11911(Instance):
    ...
    def dependency(self) -> Optional[Image]:
        return ImageDefault_13510_11911(self.pr, self._config)
