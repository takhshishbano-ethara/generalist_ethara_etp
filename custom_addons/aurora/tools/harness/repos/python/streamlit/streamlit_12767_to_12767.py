...
class ImageDefault_12767_12767(Image):
...
@Instance.register("streamlit", "streamlit_12767_to_12767")
class STREAMLIT_12767_TO_12767(Instance):
    ...
    def dependency(self) -> Optional[Image]:
        return ImageDefault_12767_12767(self.pr, self._config)
