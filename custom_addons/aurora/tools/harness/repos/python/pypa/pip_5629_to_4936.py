...
class PipImageDefault5629(Image):
    def __init__(self, pr: PullRequest, config: Config):
        self._pr = pr
        self._config = config
    ...
    def dependency(self) -> Union[Image, None]:
        return PipImageBase5629(self.pr, self._config)
...
@Instance.register("pypa", "pip_5629_to_4936")
class PIP_5629_TO_4936(Instance):
    ...
    def dependency(self) -> Optional[Image]:
        return PipImageDefault5629(self.pr, self._config)
