...
class ActixSingleImageBase(Image):
...
class ActixSingleImageDefault(Image):
    def __init__(self, pr: PullRequest, config: Config):
        self._pr = pr
        self._config = config
    ...
    def dependency(self) -> Image | None:
        return ActixSingleImageBase(self.pr, self.config)
...
@Instance.register("actix", "actix_304_to_27")
class ACTIX_304_TO_27(Instance):
    ...
    def dependency(self) -> Optional[Image]:
        return ActixSingleImageDefault(self.pr, self._config)
