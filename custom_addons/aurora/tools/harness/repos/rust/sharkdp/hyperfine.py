...
class HyperfineImageBase(Image):
...
class HyperfineImageDefault(Image):
    def __init__(self, pr: PullRequest, config: Config):
        self._pr = pr
        self._config = config
    ...
    def dependency(self) -> Image | None:
        return HyperfineImageBase(self.pr, self.config)
...
@Instance.register("sharkdp", "hyperfine")
class Hyperfine(Instance):
    ...
    def dependency(self) -> Optional[Image]:
        return HyperfineImageDefault(self.pr, self._config)
