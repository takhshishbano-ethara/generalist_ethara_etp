...
class AxumImageDefault(Image):
    ...
    def dependency(self) -> Image | None:
        return AxumImageBase(self.pr, self.config)
...
@Instance.register("tokio-rs", "axum")
class Axum(Instance):
    ...
    def dependency(self) -> Optional[Image]:
        return AxumImageDefault(self.pr, self._config)
