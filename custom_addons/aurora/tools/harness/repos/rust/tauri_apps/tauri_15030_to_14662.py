...
class ImageBase15030to14662(Image):
...
class ImageDefault15030to14662(Image):
    def __init__(self, pr: PullRequest, config: Config):
        self._pr = pr
        self._config = config
    ...
    def dependency(self) -> Image | None:
        return ImageBase15030to14662(self.pr, self.config)
...
@Instance.register("tauri-apps", "tauri_15030_to_14662")
class Tauri15030to14662(Instance):
    ...
    def dependency(self) -> Optional[Image]:
        return ImageDefault15030to14662(self.pr, self._config)
