...
class ImageDefault258to167(Image):
    def __init__(self, pr: PullRequest, config: Config):
        self._pr = pr
        self._config = config
    ...
    def dependency(self) -> Image | None:
        return ImageBase258to167(self.pr, self.config)
...
@Instance.register("tauri-apps", "tauri_258_to_167")
class Tauri258to167(Instance):
    ...
    def dependency(self) -> Optional[Image]:
        return ImageDefault258to167(self.pr, self._config)
