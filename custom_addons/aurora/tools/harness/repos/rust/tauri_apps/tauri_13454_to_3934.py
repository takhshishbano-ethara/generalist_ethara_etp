...
class ImageBase13454to3934(Image):
...
class ImageDefault13454to3934(Image):
    def __init__(self, pr: PullRequest, config: Config):
        self._pr = pr
        self._config = config
    ...
    def dependency(self) -> Image | None:
        return ImageBase13454to3934(self.pr, self.config)
...
@Instance.register("tauri-apps", "tauri_13454_to_3934")
class Tauri13454to3934(Instance):
    ...
    def dependency(self) -> Optional[Image]:
        return ImageDefault13454to3934(self.pr, self._config)
