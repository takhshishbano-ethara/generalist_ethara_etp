...
class S3StorageError(Exception):
    """Generic T2AV S3 storage error (raised back to the caller)."""
...
class T2AVS3Storage(models.AbstractModel):
    _name = "t2av.s3.storage"
    _description = "T2AV S3 storage helper (presigned URLs + SHA-256)"
    ...
    def _client_for(self, connector):
        ...
        with _CACHE_LOCK:
            ...
            _logger.info(
                "T2AV S3: client created for connector_id=%s region=%s",
