...
These output rules exist because the generated PRD will be audited by the Leviathan QC rubric, which treats markdown tables and non-keyboard symbols as ship-blocking High issues (H15 and H16). A PRD that violates these rules cannot ship regardless of how accurate its content is.
