...
class EtharaProjectBudgetSubscriptionLine(models.Model):
    _name = 'ethara.project.budget.subscription.line'
    _description = 'Ethara Project Budget Subscription Line'
    _order = 'id'
    ...
    assigned_user_ids = fields.Many2many(
        ...
        relation='ethara_project_budget_sub_line_user_rel',
