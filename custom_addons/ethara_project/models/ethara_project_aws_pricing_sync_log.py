...
class EtharaProjectAwsPricingSyncLog(models.Model):
    _name = "ethara.project.aws.pricing.sync.log"
    _description = "Ethara Project AWS Pricing Sync Audit Log"
    ...
    def action_run_sync_from_cron(self):
        from odoo.addons.ethara_project.services import aws_pricing_service as _ps
