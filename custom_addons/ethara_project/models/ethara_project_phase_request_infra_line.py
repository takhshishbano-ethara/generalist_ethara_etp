...
class EtharaProjectPhaseRequestInfraLine(models.Model):
    _name = 'ethara.project.phase.request.infra.line'
    _description = 'Ethara Project Phase Request Infrastructure Line'
    _order = 'id'
