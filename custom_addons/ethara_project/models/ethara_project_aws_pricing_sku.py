...
class EtharaProjectAwsPricingSku(models.Model):
    _name = "ethara.project.aws.pricing.sku"
    _description = "Ethara Project AWS Pricing SKU (Region-specific priced item)"
    _order = "service_code, item_name, region_label"
    _rec_name = "aws_sku"

    item_id = fields.Many2one(
        "ethara.project.aws.pricing.item",
        string="Item",
        required=True,
        ondelete="cascade",
        index=True,
