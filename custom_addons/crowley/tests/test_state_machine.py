"""Crowley v1.1 Job + Attempt state-machine tests.

Most fields moved off the parent ``crowley.generation`` (job) onto the new
``crowley.attempt`` rows. These tests cover the new schema:
