...
ORM dependencies. The `@tagged` decorator lets `--test-tags crowley` pick it up.
"""
...
from odoo.addons.crowley.services import openrouter_client
from odoo.addons.crowley.services.openrouter_client import (
    BASE_URL,
    OpenRouterAPIError,
    OpenRouterAuthError,
