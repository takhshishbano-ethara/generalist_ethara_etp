"""Crowley extension of ``ir.attachment``.

Adds two backref fields so generated video attachments can be queried by
job or attempt. Used by ``crowley.attempt._run_download`` (Wave 4D) to
...
class IrAttachment(models.Model):
    ...
    crowley_attempt_id = fields.Many2one(
        "crowley.attempt",
        string="Crowley Attempt",
        index=True,
        ondelete="set null",
