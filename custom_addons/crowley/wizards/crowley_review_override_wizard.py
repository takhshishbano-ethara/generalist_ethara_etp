...
class CrowleyReviewOverrideWizard(models.TransientModel):
    _name = "crowley.review.override.wizard"
    _description = "Crowley Video Review Human-Verdict Override Wizard"

    review_id = fields.Many2one(
        "crowley.video.review", string="Review",
