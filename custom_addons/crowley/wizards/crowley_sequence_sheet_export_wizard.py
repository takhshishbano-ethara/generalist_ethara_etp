...
class CrowleySequenceSheetExportWizard(models.TransientModel):
    _name = "crowley.sequence.sheet.export.wizard"
    _description = "Crowley Sequence Sheet Export Wizard"
    ...
    def action_build_xlsx(self):
        ...
        Row = self.env["crowley.sequence.sheet.row"]
