...
class TestRabbitMQGetChannel(TransactionCase):
    ...
    def setUp(self):
        super().setUp()
        import odoo.addons.skoll.services.rabbitmq_service as svc
        self._svc = svc
    ...
    @patch("odoo.addons.skoll.services.rabbitmq_service.pika")
...
class TestRabbitMQPublish(TransactionCase):
    ...
    @patch("odoo.addons.skoll.services.rabbitmq_service._get_channel")
    def test_publish_connection_error_retries(self, mock_get_channel):
        ...
        self._svc._publish("skoll_auto_process", '{"test": true}')
