...
class TestValidateTrajectory(SkollTestCase):
...
@tagged("post_install", "-at_install")
class TestBuildReport(SkollTestCase):
...
@tagged("post_install", "-at_install")
class TestHelperFunctions(SkollTestCase):
...
@tagged("post_install", "-at_install")
class TestHintsMode(SkollTestCase):
...
@tagged("post_install", "-at_install")
class TestEnvelopeEdgeCases(SkollTestCase):
...
@tagged("post_install", "-at_install")
class TestToolCallEdgeCases(SkollTestCase):
...
@tagged("post_install", "-at_install")
class TestMetaInfoEdgeCases(SkollTestCase):
