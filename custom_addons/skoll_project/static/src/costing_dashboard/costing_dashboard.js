...
export class CostingDashboard extends Component {
    static template = "skoll.CostingDashboard";
    ...
    async _loadData() {
        ...
        try {
            const res = await rpc("/skoll/costing/data", { period: this.state.period });
...
registry.category("actions").add("skoll_costing_dashboard", CostingDashboard);
