 ...
 */
export class Kensei2ListStats extends Component {
    static template = "project_tracker.ListStats";
    static props = {
        cards: { type: Array },
 ...
 */
export class Kensei2StatsListController extends ListController {
    static template = "project_tracker.StatsListView";
    static components = { ...ListController.components, Kensei2ListStats };
    ...
    async _loadStats() {
        ...
        try {
            const res = await rpc("/project_tracker/list_stats", {
            ...
            console.warn("[kensei2-list-stats]", e);
        } finally {
            if (seq === this._statsSeq) {
...
registry.category("views").add("project_tracker_stats_list", {
    ...listView,
    Controller: Kensei2StatsListController,
});
