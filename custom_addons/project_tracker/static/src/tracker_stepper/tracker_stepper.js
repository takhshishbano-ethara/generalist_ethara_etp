...
// ladder does (project_tracker_allocation._compute_status), so the stepper can never
...
export class Kensei2TrackerStepper extends Component {
    static template = "project_tracker.TrackerStepper";
    static props = { "*": true };
...
registry.category("view_widgets").add("project_tracker_stepper", {
