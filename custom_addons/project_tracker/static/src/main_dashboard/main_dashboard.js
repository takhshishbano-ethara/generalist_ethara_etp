...
import { Kensei2TrackerDashboard } from "@project_tracker/tracker_dashboard/tracker_dashboard";
import { Kensei2TaskerDashboard } from "@project_tracker/tasker_dashboard/tasker_dashboard";
...
export class Kensei2Dashboard extends Component {
    ...
    setup() {
        ...
        onWillStart(async () => {
            this.state.isLead =
                (await user.hasGroup("project_tracker.group_project_tracker_ql")) ||
...
registry.category("actions").add("project_tracker_main_dashboard", Kensei2Dashboard);
