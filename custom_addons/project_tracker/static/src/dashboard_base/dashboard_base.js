...
import { isoLocal, fmt } from "@project_tracker/tracker_common";
...
export class Kensei2DashboardBase extends Component {
    ...
    /** Project filter (only dashboards whose state carries `projects` show it). */
    onProjectChange(ev) {
    ...
    csvFileName() {
        return "project_tracker_main_dashboard.csv";
    }
