 ...
 *
 * Scoped to `widget="project_tracker_statusbar"`; every other statusbar is untouched.
 */
...
registry.category("fields").add("project_tracker_statusbar", kensei2StatusBarField);
