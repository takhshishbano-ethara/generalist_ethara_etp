...
class TestJobCreate(GohanTestCase):
...
@tagged("post_install", "-at_install", "gohan")
class TestJobWrite(GohanTestCase):
...
@tagged("post_install", "-at_install", "gohan")
class TestHasExtractionData(GohanTestCase):
...
class TestPromptHelpers(GohanTestCase):
    ...
    def test_qc_prompt_falls_back_to_default(self):
        ...
        self._set_param("gohan.qc_system_prompt", "")
