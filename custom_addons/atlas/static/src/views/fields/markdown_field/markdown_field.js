...
export class AtlasMarkdownField extends Component {
    static template = "atlas.MarkdownField";
    static props = {
        ...standardFieldProps,
...
export const atlasMarkdownField = {
    component: AtlasMarkdownField,
...
registry.category("fields").add("atlas_markdown", atlasMarkdownField);
