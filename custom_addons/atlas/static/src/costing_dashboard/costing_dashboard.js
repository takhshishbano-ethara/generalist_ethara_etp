...
export class CostingDashboard extends Component {
    static template = "atlas.CostingDashboard";
    ...
    async _loadData() {
        ...
        try {
            const res = await rpc("/atlas/costing/data", { period: this.state.period });
...
registry.category("actions").add("atlas_costing_dashboard", CostingDashboard);
