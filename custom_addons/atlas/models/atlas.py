...
class Atlas(models.Model):
    ...
    rubric_trial_input_tokens = fields.Integer(string="Rubric Trial Input Tokens", default=0)
    rubric_trial_output_tokens = fields.Integer(string="Rubric Trial Output Tokens", default=0)
