...
_HINT_MOD = "odoo.addons.skoll.controllers.auto_hint"


@tagged("post_install", "-at_install")
class TestAutoHintEval(SkollTestCase):
    ...
    def test_auto_hint_submits_background(self):
        from odoo.addons.skoll.controllers.auto_hint import AutoHintController
...
@tagged("post_install", "-at_install")
class TestAutoHintHelpers(SkollTestCase):

    def test_format_conversation_user_messages(self):
        from odoo.addons.skoll.controllers.auto_hint import _format_conversation
...
@tagged("post_install", "-at_install")
class TestAutoHintAccumulateTokens(SkollTestCase):

    def test_accumulate_qwen_tokens(self):
        from odoo.addons.skoll.controllers.auto_hint import _accumulate_qwen_tokens
