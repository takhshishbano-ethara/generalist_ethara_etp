...
def _gog_config_dir(task_id):
    ...
    base = os.path.join(tempfile.gettempdir(), ".skoll-gog-config")
...
class SkollGogAuthController(http.Controller):
    ...
    @http.route("/skoll/gog/start_auth", type="json", auth="user")
    ...
    @http.route("/skoll/gog/exchange_token", type="json", auth="user")
    ...
    @http.route("/skoll/gog/status", type="json", auth="user")
