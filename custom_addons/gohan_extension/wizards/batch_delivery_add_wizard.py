...
class GohanBatchDeliveryAddWizard(models.TransientModel):
    _name = "gohan.batch.delivery.add.wizard"
    _description = "Add Gohan Jobs to Batch Delivery"
    ...
    def default_get(self, fields_list):
        ...
        if active_model == "gohan.job" and active_ids:
    ...
    def action_confirm(self):
        ...
        if self.mode == "existing":
            ...
            batch = self.env["gohan.batch.delivery"].create({
        ...
        return {
            ...
            "res_model": "gohan.batch.delivery",
            "res_id": batch.id,
            "view_mode": "form",
            "target": "current",
        }
