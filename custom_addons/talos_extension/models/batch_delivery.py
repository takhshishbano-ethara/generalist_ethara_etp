...
class TalosBatchDelivery(models.Model):
    _name = "talos.batch.delivery"
    _description = "Talos Batch Delivery"
    ...
    job_ids = fields.Many2many(
        "talos.talos",
        relation="talos_batch_delivery_job_rel",
        column1="batch_id",
        column2="job_id",
        string="Talos Tasks",
    )
    ...
    column_ids = fields.Many2many(
        "ir.model.fields",
        relation="talos_batch_delivery_column_rel",
        column1="batch_id",
        column2="field_id",
        string="CSV Columns",
        domain=[("model", "=", "talos.talos")],
